...
// ================ MEM I / O =====================//
    ...
    input   logic   [`DATA_WIDTH -1:0]  MEM_pc,
    input   logic   [`DATA_WIDTH -1:0]  MEM_ALU,
    input   logic   [`DATA_WIDTH -1:0]  MEM_ALU_FP,
    input   logic   [`DATA_WIDTH -1:0]  MEM_csr,
    input   logic   [4:0]               EXE_MEM_rd_addr,
...
always_comb begin
    ...
    DM_in   =   32'd0;
    case (EXE_funct3)
        3'b000: DM_in[{MEM_ALU[1:0],3'b0} +: 8]     =    EXE_rs2_data[7:0]; // SB
...
always_comb begin
    ...
    case (EXE_funct3) // sign extension
        3'b000: DM_out_2_reg    =   {{24{DM_out[7]}},DM_out[7:0]} ; // LB(signed) 
        3'b001: DM_out_2_reg    =   {{16{DM_out[15]}},DM_out[15:0]}; // LH
